...
sheet_name = eval(HandleConfig().get_value('basicdata.ini', 'excel', 'commonCompany_sheet_name'))
file_name = os.path.join(testData_dir, file_name)
commonCompany_data = HandleExcel(file_name, sheet_name).read()
